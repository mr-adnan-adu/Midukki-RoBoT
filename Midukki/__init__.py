...
class Configs(object):
    ...
    if environ.get("BOT_PICS"):
        START_PICS = (environ.get("BOT_PICS", "https://te.legra.ph/file/9ef2da79f8ab6055779de.jpg")).split()
    ...
    SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/malayalamaudiobooksebooks')
